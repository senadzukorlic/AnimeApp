...
import logoFoooter from './logoFoooter.png'; // Ispravljeno ime fajla
import { Link } from 'react-router-dom';
import { FooterContainer, FooterContent, FooterLogo, FooterText, FooterText2 } from './FooterStyled'; // Uvoz iz .styles fajla
