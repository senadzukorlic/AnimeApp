...
import Image from '../AboutUs/download.png'; // Ensure this path points to your image file
import { ProfileCardsContainer } from './AboutUsStyled'; // Ensure this path is correct
...
export function AboutUs() {
    const socialLinksSenad = [
        ...
        { href: "https://linkedin.com/in/senad-zukorlic-49343a276/", iconClass: "fab fa-linkedin" }
    ];
    const socialLinksDzenis = [
        { href: "#", iconClass: "fab fa-facebook-square" },
        { href: "#", iconClass: "fab fa-instagram" },
        { href: "https://github.com/DzenisFejzovic", iconClass: "fab fa-github" },
        { href: "https://linkedin.com/in/dzenis-fejzovic-ba0aa5316", iconClass: "fab fa-linkedin" }
    ];
    const socialLinksAjtana = [
        { href: "#", iconClass: "fab fa-facebook-square" },
        { href: "#", iconClass: "fab fa-instagram" },
        { href: "https://github.com/AjtanaDjerlek", iconClass: "fab fa-github" },
        { href: "https://linkedin.com/in/ajtana-djerlek-121264317", iconClass: "fab fa-linkedin" }
    ];
    const socialLinksHaris = [
        { href: "#", iconClass: "fab fa-facebook-square" },
        { href: "#", iconClass: "fab fa-instagram" },
        { href: "https://github.com/harisbecirovic", iconClass: "fab fa-github" },
        { href: "https://www.linkedin.com/in/haris-becirovic-142565267/", iconClass: "fab fa-linkedin" }
    ];
